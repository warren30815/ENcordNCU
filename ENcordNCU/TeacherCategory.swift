...
class TeacherCategory: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "teachermenutoclass"{
            let index = table.indexPathForSelectedRow?.row
            let vc = segue.destination as! TeacherMenu
